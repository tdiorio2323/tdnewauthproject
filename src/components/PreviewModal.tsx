  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm">
      <div className="relative w-full max-w-2xl mx-4">
        ...
        {/* Preview content */}
        <div className="relative rounded-2xl border border-transparent bg-white/5 p-6 backdrop-blur-2xl shadow-[0_10px_40px_-12px_rgba(0,0,0,.6)] [background:linear-gradient(#0e0f12,#0e0f12)_padding-box,linear-gradient(135deg,#87e6ff,#b48cff,#f5cf7a)_border-box]">
          {/* Top hairline */}
